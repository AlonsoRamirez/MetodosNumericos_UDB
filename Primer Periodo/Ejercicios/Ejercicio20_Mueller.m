...
f = input('Ingrese la función f: '); %3*x^5+11*x^4-21*x^3-10*x^2+21*x+15
x0 = input('Ingrese el valor de x0: '); %-5.5
x1 = input('Ingrese el valor de x1: '); %-5.2
x2 = input('Ingrese el valor de x2: '); %-4.5
